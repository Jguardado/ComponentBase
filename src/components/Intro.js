  ...
  render() {
    return (
      <div className='intro mainTwo'>
        <p className='container headingtext'>This library is compiled of commonly used a components and is for the use in personal construction of your own React websites
