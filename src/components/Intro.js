  ...
  render() {
    return (
      <div className='intro mainTwo'>
        <p className='container headingtext'>ComponentBase is a library that is
        compiled of commonly used a components and is intended for the use in personal
        construction of React websites. The goal is to provide readily compatible code
        ...
        <p className='container headingtext'>This library is a work in progress.
