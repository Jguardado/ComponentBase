  ...
  render() {
    return (
      <div className='intro mainTwo'>
        ...
        used a <Link to='/component'>components</Link>. It is a tool for Engineers. Each
        ...
        to make a pull request. Being an advocate of open-source I welcome                                         <a href='https://github.com/Jguardado/ComponentBase/issues'>contributions and review</a>.
        ...
        Its a great way for anyone to get a jump start on their projects.                                        </p>
      </div>
    );
  }
}
